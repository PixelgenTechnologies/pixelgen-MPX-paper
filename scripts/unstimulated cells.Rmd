...
plot_data %>% 
  write_csv("results/unstimulated/extended figure 1 source data.csv")
...
plot_data %>% 
  ...
  write_csv("results/unstimulated/fig2B source data.csv")
...
plot_data <- 
  ...
  mutate(cell_type_name = factor(cell_type_name, 
                                 rev(c("CD4 T cells",
                                       ...
                                       "Monocytes")))) 
plot_data %>% 
  arrange(cell_type_name, sample) %>% 
  write_csv("results/unstimulated/fig2C source data.csv")
...
plot_data %>% 
  write_csv("results/unstimulated/fig2D source data.csv")
...
umap_data %>% 
  write_csv("results/unstimulated/fig2A source data.csv")
...
plot_data %>% 
  write_csv("results/unstimulated/extended fig4A source data.csv")
...
plot_data %>% 
  as_tibble(rownames = "sample_component") %>% 
  write_csv("results/unstimulated/extended fig4B source data.csv")
...
plot_data %>% 
  write_csv("results/unstimulated/extended fig4DE source data.csv")
...
plot_data %>% 
  write_csv("results/unstimulated/extended fig4C source data.csv")
...
plot_data %>% 
  as_tibble() %>% 
  write_csv("results/unstimulated/extended fig4F source data 1.csv")

plot_data %>% 
  activate(edges) %>% 
  as_tibble() %>% 
  write_csv("results/unstimulated/extended fig4F source data 2.csv")
